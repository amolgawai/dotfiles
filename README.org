...
- Terminal Emulators
  - Primary- [[https://github.com/ghostty-org/ghostty][Ghostty]], [[https://github.com/kovidgoyal/kitty][kitty]]
  - Fun -> [[https://github.com/GitSquared/edex-ui][edex-ui]]
  - secondary [[https://www.iterm2.com][iTerm2]], [[https://github.com/alacritty/alacritty][Alacritty]]
...
- Productivity and Modern tools
  - [[https://github.com/junegunn/fzf][fzf]] The command line fuzzy finder ([[file:cheatsheetNquickrefs/fzf_quickref.md][quickref]])
      - [[https://github.com/alexpasmantier/television][television]] -> Blazing fast general purpose fuzzy finder TUI.
